...
void Gameloop::Init()
{
    ...
    gWindow = SDL_CreateWindow("Flappy Bird update score", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT , SDL_WINDOW_SHOWN);
    if( gWindow == NULL)
    {
    ...
    else
    {
        ...
        else
        {
			...
			//font
			point.CreateFont("Font/flappy-font.ttf", 35);
        }
    }
...
{
    string s;
    s = "SCORE " + to_string(points);
    point.TXT(s, 255, 255, 255, gRenderer);
